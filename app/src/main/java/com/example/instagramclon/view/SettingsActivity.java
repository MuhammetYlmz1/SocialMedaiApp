...
public class SettingsActivity extends AppCompatActivity {
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if (result) {
                    ...
                    Toast.makeText(SettingsActivity.this,"İzine ihtiyaç var!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void clickSave(View view) {
        ...
        if (settingsData.get("user_fullname").toString().matches("")) {
            Toast.makeText(SettingsActivity.this,"İsminizi Giriniz!",Toast.LENGTH_SHORT).show();
        } else {
            setStorage();
        }
    }
